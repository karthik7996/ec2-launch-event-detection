pipeline {
    ...
    environment {
        ...
        STACK_NAME = 'Ec2-launch-event-detection'
        TEMPLATE_FILE = 'ec2-launch-event-detection.yaml'
        PROJECT_NAME = 'Ec2-launch-event-detection'
    ...
    stages {
       stage('checkout'){
            steps{
                git credentialsId: 'MY_BB_CRED', url: 'https://SreekantReddy@bitbucket.org/cloudzenix/ec2-launch-event-detection.git'
            }
       }
        stage('Build') {
            steps {
